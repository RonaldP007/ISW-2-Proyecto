                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-success">
                        ...
                        <?php endif; ?>
                            ...
                            <form method="post" action="<?php echo base_url('Productos/nuevo_producto'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Cantidad" name="cantidad" type="text" onkeypress="return validar(event)" required
                                            value="<?php
                                            if(isset($error)){
                                                echo $this->session->flashdata('cantidad');
                                            }    
                                        ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Precio" name="precio" type="text" onkeypress="return validar(event)" required
                                            value="<?php
                                            if(isset($error)){
                                                echo $this->session->flashdata('precio');
                                            }    
                                        ?>">
                                    </div>
